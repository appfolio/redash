...
S3_AND_REDSHIFT_STREAM = os.environ.get("S3_AND_REDSHIFT_EVENT_STREAM", "")
S3_ONLY_STREAM = os.environ.get("S3_ONLYSTREAM", "")
...
BAMBOOHR_API_KEY = os.environ.get("REDASH_BAMBOOHR_API_KEY", "")
